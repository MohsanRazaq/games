    ...
    while guesses > 0 and not is_word_guessed(secret_word, letters_guessed):
        ...
        if not guess.isalpha() or len(guess) != 1:
            ...
            if warnings > 0:
                ...
                print("Oops! That is not a valid letter. ""You lose one guess:",get_guessed_word(secret_word, letters_guessed))
        ...
        if guess in letters_guessed:
            ...
            if warnings > 0:
                ...
                print("Oops! You've already guessed that letter. ""You lose one guess:",get_guessed_word(secret_word, letters_guessed))
